...
from btfactory.models import Actress
from btfactory.forms import ActressSearchForm
...
def home(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render_to_response(u'index.html',{'atresses':actresses,'form':form}, context_instance=RequestContext(request))
