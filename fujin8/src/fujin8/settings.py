...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(DIRNAME, 'ityao.db'),                # Or path to database file if using sqlite3.
...
#STATIC_ROOT = "/Users/silver/Documents/static"
...
SECRET_KEY = '&(#)zdbnk=#y3l)bfq0$l+(f=e4g1p3nucm1eztfjbyi2n(2(b'
